...
| **W1** | 평가 데이터셋(우선 BDD100K)·`yolov8n.pt`·KITTI 라이선스 원문 확인 | **[사용자] — 여기서 막힌다** |
| **W2** | ~~1차 비교 질문~~ **정했다 — Q-A 1차 + Q-C 보조** | 끝 (2026-09-16) |
| W3 | 최소 구현 — 모집단·방법별 예산·비교 모드·무작위 표본 | **끝 (2026-09-16)** |
| **W5** | 데이터셋·경계·N·K·씨앗·1차 지표·Δ 방침, 사전 등록 커밋 | **[사용자]** — W1 뒤 |
| W4 | 경로 드라이런 — 실제 추론·묶음·합성 판정·집계 | **끝 (2026-09-16)** |
| W6 | 받기·진단·묶음·가림 점검·판정 | **[사용자]** 승인·판정 |
| W7 | 집계·감사·결과 문서 | Claude |

**W1·W5가 정해지기 전에는 새 기능을 만들지 않는다.** 판정량 가늠은 드라이런 수치로 한다 —
N=90·K=50이면 판정 대상 388건이었다(`experiment/planning_evidence/w4_dryrun.json`).
