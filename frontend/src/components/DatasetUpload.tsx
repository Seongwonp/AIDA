        ...
        <div className="upload-result">
          ...
          {labelResult.order_basis === "relative" && (
            <p className="report-caveat">
              ...
              크게 도움이 됩니다), <strong>라벨 누락·중복·클래스 오기입이 약하게 섞인
              경우</strong>입니다. 후자라면 모델 자신의 오탐이 진짜 오류보다 많아 이
              순서가 오탐을 좇고 있을 수 있습니다. 크기·위치 오류는 이 위험이 없고,
              위험해지는 비율은 오류 유형마다 다릅니다
              (실측 표: docs/21 AO·AW·AX·AY).
            </p>
          )}
